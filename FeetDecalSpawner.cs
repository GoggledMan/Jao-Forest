...
namespace Knife.RealBlood
{
    ...
    public class FeetDecalSpawner : MonoBehaviour
    {
        ...
        [SerializeField] private DecalInstance leftFootDecalTemplate;
        [SerializeField] private DecalInstance rightFootDecalTemplate;
        ...
        private void Spawn(float randomOffset)
        {
            ...
            if (hasGround)
            {
                ...
                instance.Material.SetFloat("_Alpha", Energy / maxEnergy);
